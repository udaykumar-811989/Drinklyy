...
export function PrivacyPolicy() { return <PolicyPage title="Privacy Policy"><h3>Your privacy matters</h3><p>Drinkly uses the information you provide to fulfil orders, improve the app, and support your account. We do not sell your personal information.</p><h3>Information we use</h3><p>Your name, contact details, delivery address, and order history are used only to provide the Drinkly service.</p></PolicyPage> }
export function Terms() { return <PolicyPage title="Terms & Conditions"><h3>Using Drinkly</h3><p>Drinkly is an alcohol delivery platform. Orders, payments, and delivery tracking are managed through our backend systems.</p><h3>Age requirement</h3><p>You must be legally permitted to purchase alcohol in your location. Valid identification may be required at delivery.</p></PolicyPage> }
